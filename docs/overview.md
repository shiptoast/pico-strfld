...
- `music.lua`: pause-menu track selection and looping playback.
...
- Pause menu music: Left / Right selects `off` or a looping track; the selected
  track continues after leaving the pause menu.
